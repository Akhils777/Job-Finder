  ...
  return (
    <>
      {loading ? (
        ...
        <h1>You have no applications from job Finder.</h1>
      ) : (
        <>
                ...
                return (
                  <div className="card" key={element._id}>
                    ...
                    <p className="sub-sec">
                      ...
                      {element.jobFinderInfo.name}
                    </p>
                    <p className="sub-sec">
                      <span>Applicant's Email:</span>{" "}
                      {element.jobFinderInfo.email}
                    </p>
                    <p className="sub-sec">
                      <span>Applicant's Phone: </span>{" "}
                      {element.jobFinderInfo.phone}
                    </p>
                    <p className="sub-sec">
                      <span>Applicant's Address: </span>{" "}
                      {element.jobFinderInfo.address}
                    </p>
                    <p className="sub-sec">
