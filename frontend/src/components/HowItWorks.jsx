    ...
    <section className="howItWorks">
      ...
      <div className="container">
        <div className="card">
          ...
          <p>
            Sign up for a free account as a job finder or employer. Set up your
        ...
        <div className="card">
          ...
          <p>
            Employers can post detailed job descriptions, and job finder can
        ...
        <div className="card">
          ...
          <p>
            ...
            finder can review job offers and accept positions that align with
            their career goals.
          </p>
        </div>
      </div>
