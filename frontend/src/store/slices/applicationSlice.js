...
export const fetchEmployerApplications = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `https://job-finder-682s.vercel.app/api/v1/application/employer/getall`,
      {
...
export const fetchJobFinderApplications = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `https://job-finder-682s.vercel.app/api/v1/application/jobfinder/getall`,
      {
        withCredentials: true,
      }
    );
...
export const postApplication = (data, jobId) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      `https://job-finder-682s.vercel.app/api/v1/application/post/${jobId}`,
      data,
      {
        withCredentials: true,
...
export const deleteApplication = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://job-finder-682s.vercel.app/api/v1/application/delete/${id}`,
      { withCredentials: true }
    );
    dispatch(
